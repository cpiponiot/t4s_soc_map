...
```{r}
temp <- read.csv("data/cache/data_stocks.csv") %>% 
...
```{r}
prec <- read.csv("data/cache/data_stocks.csv") %>% 
  merge(read.csv("data/cache/climate_data.csv")) %>% 
...
```{r}
phys <- read.csv("data/cache/data_stocks.csv") %>% 
...
```{r}
chem <- read.csv("data/cache/data_stocks.csv") %>% 
  merge(read.csv("data/cache/soilgrids_data.csv")) %>%
  select(site, plot, T_stock, 
...
```{r}
all <- read.csv("data/cache/data_stocks.csv") %>% 
  merge(read.csv("data/cache/climate_data.csv")) %>%
  merge(read.csv("data/cache/soilgrids_data.csv")) %>%
