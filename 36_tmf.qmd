...
For plots that were recorded as forest or fallow, we used a deforestation age of 0.
Plots in areas already deforested in 1990 were attributed a deforestation age of 40.
...
"data/cache/def_age_smooth.tif" |>
  ...
  # deforestation age for forests: 0
  left_join(read.csv("data/cache/data_landuse.csv")) |>
  mutate(def_age = ifelse(present_landuse %in% c("forest", "fallow"),
    0, def_age
  )) |>
  mutate(def_age = ifelse(is.na(def_age), 40, def_age)) |>
  select(site, plot, def_age) |>
