...
Please preferentially create an issue on GitHub for any questions, bugs or help needed regarding **t4_soc_map**: [https://github.com/cpiponiot/t4s_soc_map/issues](https://github.com/cpiponiot/t4s_soc_map/issues){.uri}. However, you can contact us by email through people in the core group (see below).
